...
///
///   **"Money is between you and them."** Aangan holds nothing and takes no cut
...
const hiAbout = <String, String>{
  ...
  'Aangan does not hold your money or take a cut of what you pay. You settle directly with your professional, on the terms in the agreement. We are paid a commission by them.':
      'Aangan न आपका पैसा रखता है, न आपके भुगतान में से कुछ काटता है। आप सीधे अपने कारीगर से, एग्रीमेंट की शर्तों पर हिसाब करते हैं। हमें कमीशन वे देते हैं।',
